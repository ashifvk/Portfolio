      ...
      <div class="container">
        <div class="cs-hero_tab">
          <div class="cs-hero_tab_item cs-hover_tab active">
            <div class="cs-hero_tab_img cs-bg" data-src="<?= base_url('assets_life') ?>/img/wedding.jpeg"></div>
            <h2>
              <a href="service-details.html">Wedding</a>
            </h2>
          </div>
          <div class="cs-hero_tab_item cs-hover_tab">
            <div class="cs-hero_tab_img cs-bg" data-src="<?= base_url('assets_life') ?>/img/fashion.jpeg"></div>
            <h2>
              <a href="service-details.html">Fashion</a>
            </h2>
          </div>
          <div class="cs-hero_tab_item cs-hover_tab">
            <div class="cs-hero_tab_img cs-bg" data-src="<?= base_url('assets_life') ?>/img/commercial.jpeg"></div>
            <h2>
              <a href="service-details.html">Commercial</a>
            </h2>
          </div>
          <div class="cs-hero_tab_item cs-hover_tab">
            <div class="cs-hero_tab_img cs-bg" data-src="<?= base_url('assets_life') ?>/img/landscape.jpeg"></div>
            <h2>
          ...
          <div class="col-xl-8">
            <div class="row">
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="cs-hobble">
                  <a href="service-details.html" class="cs-card cs-style1 cs-hover_layer1">
                    <img src="<?= base_url('assets_life') ?>/img/service_1.jpeg" alt="Service" />
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="cs-hobble">
                  <a href="service-details.html" class="cs-card cs-style1 cs-hover_layer1">
                    <img src="<?= base_url('assets_life') ?>/img/service_2.jpeg" alt="Service" />
                    <div class="cs-card_overlay"></div>
                    <div class="cs-card_info">
                      <span class="cs-hover_layer3 cs-accent_bg"></span>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="cs-hobble">
                  <a href="service-details.html" class="cs-card cs-style1 cs-hover_layer1">
                    <img src="<?= base_url('assets_life') ?>/img/service_3.jpeg" alt="Service" />
                    <div class="cs-card_overlay"></div>
                    <div class="cs-card_info">
                      <span class="cs-hover_layer3 cs-accent_bg"></span>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="cs-hobble">
                  <a href="service-details.html" class="cs-card cs-style1 cs-hover_layer1">
                    <img src="<?= base_url('assets_life') ?>/img/service_4.jpeg" alt="Service" />
                    <div class="cs-card_overlay"></div>
                    <div class="cs-card_info">
                      <span class="cs-hover_layer3 cs-accent_bg"></span>
      ...
      <div class="container-fluid">
        <div class="cs-isotop cs-style1 cs-isotop_col_4 cs-has_gutter_24 cs-lightgallery">
          ...
          <div class="cs-isotop_item wedding landscape">
            <a href="<?= base_url('assets_life') ?>/img/portfolio_21_lg.jpeg" class="cs-portfolio cs-style1 cs-lightbox_item cs-size1 cs-type2">
              <div class="cs-portfolio_hover"></div>
              <span class="cs-plus"></span>
              <div class="cs-portfolio_bg cs-bg" data-src="<?= base_url('assets_life') ?>/img/portfolio_21.jpeg"></div>
          ...
          <div class="cs-isotop_item portrait short_film">
            <a href="<?= base_url('assets_life') ?>/img/portfolio_22_lg.jpeg" class="cs-portfolio cs-style1 cs-lightbox_item cs-size2 cs-type2">
              <div class="cs-portfolio_hover"></div>
              <span class="cs-plus"></span>
          ...
          <!-- .cs-isotop_item -->
          <div class="cs-isotop_item wedding landscape">
            <a href="<?= base_url('assets_life') ?>/img/portfolio_23_lg.jpeg" class="cs-portfolio cs-style1 cs-lightbox_item cs-size1 cs-type2">
              <div class="cs-portfolio_hover"></div>
              <span class="cs-plus"></span>
          ...
          <div class="cs-isotop_item fashion">
            <a href="<?= base_url('assets_life') ?>/img/portfolio_24_lg.jpeg" class="cs-portfolio cs-style1 cs-lightbox_item cs-size2 cs-type2">
              <div class="cs-portfolio_hover"></div>
              <span class="cs-plus"></span>
              <div class="cs-portfolio_bg cs-bg" data-src="<?= base_url('assets_life') ?>/img/portfolio_24.jpeg"></div>
              <div class="cs-portfolio_info">
                <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                <h2 class="cs-portfolio_title">Colorful Art Work</h2>
                <div class="cs-portfolio_subtitle">View Large</div>
          ...
          <div class="cs-isotop_item portrait">
            <a href="<?= base_url('assets_life') ?>/img/portfolio_25_lg.jpeg" class="cs-portfolio cs-style1 cs-lightbox_item cs-size2 cs-type2">
              <div class="cs-portfolio_hover"></div>
              <span class="cs-plus"></span>
              <div class="cs-portfolio_bg cs-bg" data-src="<?= base_url('assets_life') ?>/img/portfolio_25.jpeg"></div>
              <div class="cs-portfolio_info">
                <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                <h2 class="cs-portfolio_title">Colorful Art Work</h2>
                <div class="cs-portfolio_subtitle">View Large</div>
          ...
          <div class="cs-isotop_item commercial">
            <a href="<?= base_url('assets_life') ?>/img/portfolio_26_lg.jpeg" class="cs-portfolio cs-style1 cs-lightbox_item cs-size2 cs-type2">
              <div class="cs-portfolio_hover"></div>
              <span class="cs-plus"></span>
              <div class="cs-portfolio_bg cs-bg" data-src="<?= base_url('assets_life') ?>/img/portfolio_26.jpeg"></div>
              <div class="cs-portfolio_info">
                <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                <h2 class="cs-portfolio_title">Colorful Art Work</h2>
                <div class="cs-portfolio_subtitle">View Large</div>
          ...
          <!-- .cs-isotop_item -->
          <div class="cs-isotop_item portrait short_film">
            <a href="<?= base_url('assets_life') ?>/img/portfolio_27_lg.jpeg" class="cs-portfolio cs-style1 cs-lightbox_item cs-size2 cs-type2">
              <div class="cs-portfolio_hover"></div>
              <span class="cs-plus"></span>
              <div class="cs-portfolio_bg cs-bg" data-src="<?= base_url('assets_life') ?>/img/portfolio_27.jpeg"></div>
              <div class="cs-portfolio_info">
                <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                <h2 class="cs-portfolio_title">Colorful Art Work</h2>
                <div class="cs-portfolio_subtitle">View Large</div>
          ...
          <div class="cs-isotop_item wedding">
            <a href="<?= base_url('assets_life') ?>/img/portfolio_28_lg.jpeg" class="cs-portfolio cs-style1 cs-lightbox_item cs-size2 cs-type2">
              <div class="cs-portfolio_hover"></div>
              <span class="cs-plus"></span>
              <div class="cs-portfolio_bg cs-bg" data-src="<?= base_url('assets_life') ?>/img/portfolio_28.jpeg"></div>
              <div class="cs-portfolio_info">
                <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                <h2 class="cs-portfolio_title">Colorful Art Work</h2>
                <div class="cs-portfolio_subtitle">View Large</div>
          ...
          <div class="cs-isotop_item fashion short_film">
            <a href="assets/img/portfolio_29_lg.jpeg" class="cs-portfolio cs-style1 cs-lightbox_item cs-size1 cs-type2">
              <div class="cs-portfolio_hover"></div>
              <span class="cs-plus"></span>
              <div class="cs-portfolio_bg cs-bg" data-src="<?= base_url('assets_life') ?>/img/portfolio_29.jpeg"></div>
              <div class="cs-portfolio_info">
                <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                <h2 class="cs-portfolio_title">Colorful Art Work</h2>
                <div class="cs-portfolio_subtitle">View Large</div>
          ...
          <div class="cs-isotop_item fashion commercial landscape">
            <a href="<?= base_url('assets_life') ?>/img/portfolio_30_lg.jpeg" class="cs-portfolio cs-style1 cs-lightbox_item cs-size1 cs-type2">
              <div class="cs-portfolio_hover"></div>
              <span class="cs-plus"></span>
              <div class="cs-portfolio_bg cs-bg" data-src="<?= base_url('assets_life') ?>/img/portfolio_30.jpeg"></div>
              <div class="cs-portfolio_info">
                <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                <h2 class="cs-portfolio_title">Colorful Art Work</h2>
                <div class="cs-portfolio_subtitle">View Large</div>
