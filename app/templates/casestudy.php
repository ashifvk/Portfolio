...
include('common/header.php') ?>
  <!-- Start Hero -->
  <div class="cs-page_heading cs-style1 cs-center text-center cs-bg" data-src="<?= base_url('assets_life') ?>/img/case_study_details_bg.jpeg">
    <div class="container">
  ...
  <div class="container">
    ...
    <img src="<?= base_url('assets_life') ?>/img/case_study_img_1.jpeg" alt="Case Study" class="w-100 cs-radius_15">
    ...
    <div class="row">
      <div class="col-sm-6">
        <img src="<?= base_url('assets_life') ?>/img/case_study_img_2.jpeg" alt="Case Study" class="w-100 cs-radius_5">
        <div class="cs-height_25 cs-height_lg_25"></div>
      </div>
      <div class="col-sm-6">
        <img src="<?= base_url('assets_life') ?>/img/case_study_img_3.jpeg" alt="Case Study" class="w-100 cs-radius_5">
        <div class="cs-height_25 cs-height_lg_25"></div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row align-items-center cs-column_reverse_lg">
        ...
        <div class="col-lg-6 offset-lg-1 text-center">
          <div class="cs-portfolio_img_in cs-shine_hover_1 rounded-circle">
            <img src="<?= base_url('assets_life') ?>/img/case_study_img_4.png" alt="Case study" class="w-100">
          </div>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 text-center">
          <div class="cs-portfolio_img_in cs-shine_hover_1 rounded-circle">
            <img src="<?= base_url('assets_life') ?>/img/case_study_img_5.png" alt="Case study" class="w-100">
          </div>
          <div class="cs-height_0 cs-height_lg_40"></div>
        </div>
