...
include('common/header.php') ?>
  ...
  #photography{
    ...
    <div class="cs-page_heading cs-style1 cs-center text-center cs-bg" data-src="<?= base_url('assets_life') ?>/img/about_hero_bg.jpeg">
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-5 col-lg-6">
            <div class="cs-image_layer cs-style1">
              <div class="cs-image_layer_inffff">
                <img src="<?= base_url('assets_life') ?>/img/aboutus-main.png" alt="Image" class="w-100 cs-radius_15">
              </div>
            </div>
          ...
          <div class="col-xl-5 offset-xl-1 col-lg-6">
            ...
            <h4 style='margin:0;margin-bottom: -12px;'>WHO WE ARE? </h4>
              <h2  style="color: #A259FF;margin:0;"><b>WE'RE THE</b>
               <br>
               <span id='best-span' >BEST</span>
              </h2>
              <h3 class="cs-section_subtitle"style='margin-top: -12px;'>JUST ASK OUR CLIENTS</h3>
              <!-- <div class="cs-height_30 cs-height_lg_20"></div> -->
              <p style='margin:0;'>Craving a brand makeover?</p>
                <p>Craving a brand makeover?
                Grab a coffee and Join us at Evoxign, Where Our team of creative geniuses thrives on understanding everyday people and crafting extraordinary ideas that make your brand shine. We combine innovation with precision to craft tailor-made strategies and stunning visuals, propelling your brand to new heights. Elevate your digital presence with Evoxign, where exceptional design and customer satisfaction redefine success in the digital realm. Letâ€™s turn your vision into reality!
              </p>
              <div class="cs-height_15 cs-height_lg_15"></div>
              <!-- <p class="cs-m0">Dive into a partnership where innovation meets intuition, and solutions are tailored uniquely for you. At Evoxign, we don't just navigate the digital landscape - we redefine it. Make a choice that echoes your brand's individuality.</p> -->
        ...
        <div class="cs-funfact_wrap">
          ...
          <div class="cs-funfact_left">
            <div class="cs-funfact_heading">
              <h2>Our fun fact</h2>
              <p>
              "Did you know? More than 90% of marketers believe that social media marketing has boosted their brand visibility, showing its strong influence in connecting with and finding audiences globally. Power up your brand�s reach using our expert social media strategies.�
</p>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-6 offset-xl-1 col-lg-6">
            <div class="cs-section_heading cs-style1">
              <p class="cs-section_subtitle" style="color: white;">Why Choose Us</p>
              <h2 class="cs-section_title" style="color: #A259FF;">Why Evoxign Stands Out
              </h2>
              <div class="cs-height_30 cs-height_lg_20"></div>
              <p class="cs-m0">Choose Evoxign for a digital marketing journey that keeps up with the latest trends. 
                Research shows that digital media consumers are driven by social media trends. Our ethical practices 
                in digital marketing help your customers choose your business over competitors. Our strategy is to provide 
                the best service possible by experimenting with new ideas that keep your customers engaged with your products or services.
              </p>
              <div class="cs-height_15 cs-height_lg_15"></div>
              <p class="cs-m0">Dive into a partnership where innovation meets intuition, and solutions are tailored uniquely for you. At Evoxign, we don't just navigate the digital landscape - we redefine it. Make a choice that echoes your brand's individuality.</p>
              <div class="cs-height_30 cs-height_lg_30"></div>
          ...
          <div class="cs-height_0 cs-height_lg_40"></div>
            <div class="cs-image_layer cs-style1">
              <div class="cs-image_layer_infff">
                <img src="<?= base_url('assets_life') ?>/img/aboutus-whychoose.png" alt="Image" class="w-100 cs-radius_15">
              </div>
            </div>
    ...
    <div class="container">
        <div class="cs-slider cs-style2 cs-gap-24">
          ...
          <h3 class="cs-section_subtitle wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s"> Our Team </h3>
                    <h2 class="cs-section_title">Exceptional Talents on Board  </h2>
                </div>
                <div class="cs-height_145 cs-height_lg_80"></div>
            </div>
            <div class="container">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="cs-team cs-style1">
                                <div class="cs-member_thumb">
                                    <img src="<?= base_url('uploads/imeage/') ?><?= $member->image ?>" alt="<?= $member->name ?>"style="height: auto;  object-fit: cover;"/>
                                    <div class="cs-member_overlayyy"></div>
                                </div>
                                <div class="cs-member_info">
                                    <h2 class="cs-member_name"><a href="<?= base_url('home/teamdetails/') . $member->id ?>"><?= $member->name ?></a></h2>
                                    <div class="cs-member_designation"><?= $member->designation ?></div>
                                </div>
                            </div>
          ...
          <div class="cs-slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="3" data-lg-slides="4" data-add-slides="4">
            <div class="cs-slider_wrapper">
              <div class="cs-slide">
                <div class="cs-team cs-style1">
                  <div class="cs-member_thumb">
                    <img src="<?= base_url('assets_life') ?>/img/member_1.jpeg" alt="Member">
              ...
              <div class="cs-slide">
                <div class="cs-team cs-style1">
                  <div class="cs-member_thumb">
                    <img src="<?= base_url('assets_life') ?>/img/member_2.jpeg" alt="Member">
                    <div class="cs-member_overlay"></div>
                  </div>
                  <div class="cs-member_info">
              ...
              <div class="cs-slide">
                <div class="cs-team cs-style1">
                  <div class="cs-member_thumb">
                    <img src="<?= base_url('assets_life') ?>/img/member_3.jpeg" alt="Member">
                    <div class="cs-member_overlay"></div>
                  </div>
                  <div class="cs-member_info">
              ...
              <div class="cs-slide">
                <div class="cs-team cs-style1">
                  <div class="cs-member_thumb">
                    <img src="<?= base_url('assets_life') ?>/img/member_4.jpeg" alt="Member">
                    <div class="cs-member_overlay"></div>
                  </div>
                  <div class="cs-member_info">
      ...
      <div class="container">
        <div class="cs-cta cs-style1 cs-bg text-center cs-shape_wrap_1 cs-position_1" data-src="<?= base_url('assets_life') ?>/img/cta_bg.jpeg">
          ...
          <div class="cs-cta_in">
            ...
            <a href="<?= base_url('home/contact') ?>"  class="cs-text_btn">
