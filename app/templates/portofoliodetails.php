...
<div class="container">
    <div class="cs-portfolio_details">
        <!-- <img src="<?= base_url('uploads/imeage/'. $portfolio_details->image2 )?>" alt="Image" class="cs-radius_15 w-100"> -->
        <!-- <img src="<?= base_url('uploads/imeage/' . $portfolio_details->image2) ?>" alt="Image" class="cs-radius_15 " style="height: 0%; width: 900px;"> -->
        <img src="<?= base_url('uploads/imeage/' . $portfolio_details->image2) ?>" alt="Image" class="cs-radius_15 " style="height: auto; max-height: 450px; width: 900px;">



        <!-- <div class="cs-portfolio_bg cs-bg" data-src="<?= base_url('uploads/imeage/' . $item->image1) ?>"></div> -->
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="cs-section_heading cs-style1">
                    ...
                    <h2 class="cs-section_title"><?= $portfolio_details->name1 ?></h2>
                    <div class="cs-height_40 cs-height_lg_20"></div>
                    <p><?= $portfolio_details->description ?></p>
                </div>
            </div>
